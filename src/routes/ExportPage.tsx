  ...
  return (
    <div>
      <div className="mb-4 flex flex-wrap items-center justify-between gap-2">
        <div>
          <h1 className="text-lg font-semibold font-cute">导出大纲</h1>
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 gap-3 lg:grid-cols-2">
            <article className="rounded border border-ink-300 cyber-surface p-5">
              <h3 className="mb-2 text-sm font-semibold font-cute text-ink-700 neon-text">Markdown 预览</h3>
              <pre className="whitespace-pre-wrap text-sm leading-6 text-ink-800 max-h-[70vh] overflow-auto">
                {md}
              </pre>
            </article>
            <article className="rounded border border-ink-300 cyber-surface p-5">
              <h3 className="mb-2 text-sm font-semibold font-cute text-ink-700 neon-text">纯文本预览</h3>
              <pre className="whitespace-pre-wrap text-sm leading-6 text-ink-800 max-h-[70vh] overflow-auto">
                {txt}
              </pre>
            </article>
