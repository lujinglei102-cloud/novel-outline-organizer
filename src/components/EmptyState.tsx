  ...
  return (
    <div data-testid="empty-state" className="flex flex-col items-center justify-center py-20">
      ...
      {actionLabel && (
        <button
          onClick={onAction}
          className="rounded bg-ink-800 px-5 py-2 text-sm text-white hover:bg-ink-700"
        >
          {actionLabel}
        </button>
      )}
    ...
    >
      ...
      >
        <div className="mb-3 flex items-center justify-between">
          <h2 className="text-base font-semibold">卡片详情</h2>
        ...
        <div className="mt-5 flex justify-between">
          <button
            ...
            className="rounded border border-ink-200 px-4 py-1.5 text-sm text-ink-700 hover:bg-ink-50"
          >
            删除
          </button>
