...
export interface DictEntry { word: string; emotion: number; intensity?: number }

export const emotionDict: DictEntry[] = [
  // 正向情绪
  { word: '甜', emotion: 4, intensity: 3 },
...
export function tagEmotion(text: string): { emotion: number; intensity: number; matched: string[] } {
  let emoSum = 0
  let intSum = 0
  let hits = 0
